...
public enum ProductSpecErrorEnum {
    ...
    CHAR_RELATIONSHIP_TYPE_IS_NULL(286064651, "relationshipType is null"),
    MAX_CARDINALITY_LESS_THAN_MIN_CARDINALITY(286064646, "maxCardinality is less than minCardinality"),
    ASSOCIATE_REPETITIVE_CHAR(286064653, "Characteristic has been established associate " +
